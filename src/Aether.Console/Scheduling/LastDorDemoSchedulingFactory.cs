...
public static class LastDorDemoSchedulingFactory
{
    ...
    public static IReadOnlyList<Resource> CreateResources()
    {
        var names = new[]
        {
            "Worker01",
    ...
    public static IReadOnlyList<Shift> CreateBiWeeklySequencePressureShifts(
